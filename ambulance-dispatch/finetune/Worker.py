...
class Worker():
    def __init__(self, buffer, lr=0.0001, gamma=0.99, max_step=60, num=1000, device=None, zone_table_path = "./data/NY_dic.pkl", hospital_table_path = "./data/hospital.xlsx", EMS_table = "./data/EMS.xlsx", model_path = None, njobs = 24, bi_direction = True, dropout = 0.0, compression = False, pretrain_model_path = None):
        super().__init__()
        self.buffer = buffer
